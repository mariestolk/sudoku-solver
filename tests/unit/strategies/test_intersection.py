...
def test_row_confined_candidate_removes_from_group() -> None:
    """Candidate confined to one group in a row is removed from the rest of
    that group."""
...
def test_column_confined_candidate_removes_from_group() -> None:
    """Candidate confined to one group in a column is removed from the rest of group."""
    # Col 0: cell_00 (group 0), cell_10 (group 0)
    #   candidate 7 confined to group 0 in col 0
    # Col 1: cell_01 (group 1), cell_11 (group 1)
    #   spans only group 1
    # Col 2: cell_02 (group 0), cell_12 (group 1)
    #   spans both groups.
    # No col-level reduction for col 2.
